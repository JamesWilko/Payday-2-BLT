...
function _G:IsCurrentPrimaryOfCategory(type)
...
function _G:IsCurrentSecondaryOfCategory(type)
...
function _G:IsCurrentWeaponPrimary()
...
function _G:IsCurrentWeaponSecondary()
	local weapon = managers.player:local_player():inventory():equipped_unit():base():selection_index()
	local curstate = managers.player._current_state
	if weapon then
		if curstate == "mask_off" then
